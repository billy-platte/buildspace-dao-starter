...
const App = () => {
  ...
  if (appError.length > 0) {
    if (error instanceof UnsupportedChainIdError) {
      ...
      return (
        <div className="unsupported-network">
          <h2>An unexpected issue occured.</h2>
          <p>
            Please retrieve a hammer and proceed to smash it into the heart of your cpu.  There's no hope for you.
          </p>
        </div>
      );
    }
